...
<Modal on:close>
	...
	>
		<h2 class="flex items-center text-2xl font-semibold text-gray-800">
			...
			<span class="h2" style="color: transparent !important;">{PUBLIC_APP_NAME}</span>
		</h2>
		...
		{#if errorMessage}
			<p class="py-1 text-sm text-red-500">Oops, something went wrong.<br>Check if you have an active Presearch subscription.</p>
		{/if}
		<form
